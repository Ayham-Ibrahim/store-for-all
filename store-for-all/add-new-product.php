            ...
            <div class="card-body px-4 py-5 px-md-5">
                 <form action="includes/API/NewProduct.php" method="POST" style="padding: inherit;" enctype="multipart/form-data">
                    ...
                    <div class="newp form-group">
                        ...
                        <input type="text" name="phone" class="form-control" id="formGroupExampleInput2" placeholder="The owner's phone number">
                    </div>
                    <?php
                    ...
                    <?php
                     if(isset($_GET['success']))
                        echo '</br><small>You product has been added successfully</small>'; 
                    ?>
